...
> WARNING: The project is still in development, come back later. In the meanwhile, feel free to buy me a coffe regardless.
...
### Main considerations affecting the architecture of the solution

The main factors governing the decisions about the architecture of the project:

- Civil and structural engineers should be able to follow and replicate the solution without excessive experience in software.
- The project must not rely on proprietary software. All technologies must be such that they are accessible to the widest public possible.
...
```console
cd .../demo-steel-beam-cross-section-optimization-ML
uv pip install -e .
```
